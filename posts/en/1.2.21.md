...
$$
l=(\nu_{1}+at_{1})t_{2} +\frac{at_{2}^{2}}{2}
$$
...
$$
a{d}t(t_{1}-t_{2}) =\frac{a(t_{2}^{2}+2t_{1}t_{2}-t_{1}^{2})}{2}
$$

$$
{d}t=\fbox{$\frac{t_{2}^{2}+2t_{1}t_{2}-t_{1}^{2}}{2(t_{1}-t_{2})}$}
$$

#### Answer

$$
\frac{t_{2}^{2}+2t_{1}t_{2}-t_{1}^{2}}{2(t_{1}-t_{2})}
$$
