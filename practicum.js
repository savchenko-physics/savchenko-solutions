...
function getPracticumBanner(lang) {
    ...
    if (l === 'ru') {
        return {
            ...
            facts: ['Регистрация до 26 июля, 09:00 UTC', 'Конкурс 27–30 июля', 'Практикум 10–21 августа · Zoom'],
    ...
    return {
        ...
        facts: ['Register by 26 Jul, 09:00 UTC', 'Contest Jul 27–30', 'Practicum Aug 10–21 · Zoom'],
