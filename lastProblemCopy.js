...
const COPY = {
    ru: {
        ...
        welcomeNote: 'Кванты игрушечные, их нельзя купить или вывести. Реакции в чате стоят больше стартовой тысячи, так что достаются только тем, кто выиграл на прогнозах.',
        ...
        chance: 'шанс',
        listHint: 'В списке все {n} нерешённых задач. Нажмите на задачу, чтобы поставить на неё кванты.',
        claimedHint: 'Кванты у вас. Выберите задачу в списке и нажмите на неё, чтобы сделать прогноз.',
        columns: { problem: 'Задача и раздел', difficulty: 'Сложность', chance: 'Шанс', payout: 'Выплата' },
        payout: 'выплата',
        buy: 'Купить',
        sell: 'Продать',
        sellAll: 'Продать всё',
        ...
        rules: [
            ...
            'Цена задачи в процентах означает шанс, который ей даёт рынок. Одна доля стоит столько же в квантах, а если задача окажется последней, каждая доля принесёт 1 ħ. Множитель показывает, во сколько раз вырастет ставка.',
            ...
            'Кванты игрушечные, их нельзя купить за деньги или вывести. На них покупаются реакции, и каждая стоит больше стартовой тысячи, поэтому купить её можно только выигрышем.',
        ],
        ...
        shopNote: 'Каждая реакция стоит больше стартовой тысячи, её можно купить только выигрышем. Купленная остаётся у вас навсегда, в чате и под решениями.',
        owned: 'Ваша',
        buyFor: 'Купить за',
    ...
    en: {
        ...
        welcomeClaim: 'Claim',
        welcomeNote: 'Quanta are play money, so they cannot be bought or cashed out. Chat reactions cost more than the starting thousand, so only people who win at predicting get them.',
        ...
        chance: 'chance',
        listHint: 'All {n} unsolved problems are listed. Tap a problem to put quanta on it.',
        claimedHint: 'The quanta are yours. Pick a problem in the list and tap it to make a prediction.',
        columns: { problem: 'Problem and section', difficulty: 'Difficulty', chance: 'Chance', payout: 'Payout' },
        payout: 'payout',
        buy: 'Buy',
        sell: 'Sell',
        sellAll: 'Sell all',
        ...
        rules: [
            ...
            'Quanta are play money, so they cannot be bought for money or cashed out. They buy reactions, and each costs more than the starting thousand, so only winnings can buy one.',
        ],
        ...
        shopNote: 'Every reaction costs more than the starting thousand, so only winnings buy one. Once bought it is yours for good, in the chat and under solutions.',
        owned: 'Yours',
        buyFor: 'Buy for',
