...
// and its pixel size (lib/videoMeta.js) reserves the box, as image bubbles do. Anything else on
// the list is a download card. html, htm, svg, js and xml stay off the list on purpose: an
// uploaded file must never be served as executable markup from this origin.
//
...
const ALL_EXTENSIONS = [...IMAGE_EXTENSIONS, ...VIDEO_EXTENSIONS, ...OTHER_EXTENSIONS];
...
module.exports = {
    IMAGE_EXTENSIONS, VIDEO_EXTENSIONS, OTHER_EXTENSIONS, ALL_EXTENSIONS,
