...
// One source for the ramp: js/palettes.js (also emitted as --ss-heat-1…9 into css/bundle.css).
const RAMP = require('../js/palettes').HEAT;
...
function heatColor(value) {
    if (value == null) return require('../js/palettes').HEAT_NONE.ink;
