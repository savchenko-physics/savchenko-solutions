...
const META = {
    ...
    insight_required: {
        ...
        explainEn: 'The size of the "aha". Low means it can be ground out with standard machinery. High means nothing happens until you see the one idea.',
        explainRu: 'Размер «озарения». Низкое значение означает, что задача решается стандартными приёмами. Высокое означает, что ничего не выйдет, пока не увидишь единственную нужную идею.',
    },
    math_level: {
        category: 'cost',
        labelEn: 'Mathematics', labelRu: 'Математика',
        explainEn: 'How much mathematical machinery is needed, such as integration, differential equations, series or vector calculus.',
        explainRu: 'Насколько сложный математический аппарат нужен, например интегрирование, дифференциальные уравнения, ряды или векторный анализ.',
    },
    physics_depth: {
        category: 'cost',
    ...
    self_containedness: {
        ...
        explainRu: 'Можно ли решить только из условия и общих рассуждений, ничего не ища дополнительно? Высокое значение означает да.',
    },
    hidden_data: {
        category: 'shape',
        ...
        explainRu: 'Требует ли решение числа или факта, которого нет в условии? Высокое значение указывает на недостаток задачи.',
    },
    answer_opacity: {
        category: 'shape',
        ...
        explainRu: 'Помог бы готовый ответ найти путь к решению? Высокое значение означает нет, сам по себе ответ ничего не подсказывает.',
    },
    wellposedness: {
        category: 'shape',
        labelEn: 'Well-posedness', labelRu: 'Корректность постановки',
        explainEn: 'Is the problem sound, with a consistent idealisation, enough data and a determinate answer? Low flags a defect in the problem itself, not in the solver.',
        explainRu: 'Корректно ли поставлена задача, с непротиворечивой идеализацией, достаточными данными и однозначным ответом? Низкое значение указывает на изъян в самой задаче, а не в решающем.',
    },
    ...
    elegance: {
        ...
        explainEn: 'The beauty of the route the solution actually takes, the short way past the integral rather than the answer itself.',
    ...
    novelty: {
        ...
        explainRu: 'Противоположность шаблонности. Высокое значение означает, что такого рода задача ещё не встречалась.',
    },
    generality: {
        category: 'reward',
