    ...
    function PrimeDistribution(problemsList) {
        ...
        return (
            ...
            problemsList
                .map(
                    (problem) => `
                <li><a href="/ru/${problem}">${problem}</a></li>`
                )
                .join("") +
            `
            </ul>`
...
<body id="top">
    <header class = "margin-main" style="text-align:center;">
       <a href="../" style="text-decoration: none;">
        ...
        На этом сайте вы можете наблюдать попытку создания первого решебника этого сборника с оформлением решений <a href="about#team">разных авторов</a>. Всего было опубликовано ${countUniquePosts()} решений из 2,023 задач. В 2023 году был запущен проект, который активно развивается на русском и английском языках. Если хотите поучаствовать, пишите <a href="mailto:alex@savchenkosolutions.com" target="_blank">alex@savchenkosolutions.com</a>.
        </p>
    </header>
